...
public class HermiteWaypointSpline {
	...
	/**
     * A HermiteSpline instance will take points and handle finding which function to use to find the
     * solution points are formatted in.
    ...
    /**
     * Takes in t and returns corresponding point from the piecewise spline function. The spline parts
     * are parametric so [0 to 1] returns f( [0 to 1] ) from the first function. The second and so on
     * splines will take in [n - 1 to n] and have it scaled for the corresponding function so that the
     ...
     * The second and so on splines will take in [n - 1 to n] and have it scaled for the corresponding
